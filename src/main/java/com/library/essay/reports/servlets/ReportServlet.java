...
public class ReportServlet extends HttpServlet {
	...
	private JasperReportGenerationResource<Essay> buildJasperReportGenerationResource(HttpServletRequest request,
			String essayIdParam) {
		...
		EssayReportDataSource essayReportDataSource = new EssayReportDataSource("Essay Report", essayList);
		...
		JasperReportGenerationResource<Essay> reportGenerationResource = new JasperReportGenerationResource<Essay>(
				reportDir + "/essayReport.jrxml", reportDir, swapFileDir, "application/pdf", essayReportDataSource);
